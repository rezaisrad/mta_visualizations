...
turnstile_colnames = c("C/A","UNIT","SCP","STATION","LINENAME","DIVISION","DATE","TIME","DESC","ENTRIES","EXITS")
turnstile_list = sapply(turnstile_files, data.table::fread, blank.lines.skip=TRUE, showProgress=TRUE, sep=',') # create a list of data.tables 
